...
*/
    ...
    Double_t eff,unceff;
    eff = (z1_T)/double(nentries);
    unceff=sqrt(eff*(1-eff)/Double_t(nentries));

    cout << "\n" << endl;
    cout << "Estimated efficiency: " << eff << " +/- " << unceff << std::endl;
